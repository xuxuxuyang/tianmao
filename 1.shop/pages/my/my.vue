...
<view class="my-view">
	<view class="my-view-user">
		<view>
			<image v-if="usering" src="https://img0.baidu.com/it/u=2104953480,3323307053&fm=26&fmt=auto" mode="widthFix"></image>
			<!-- <image v-if="usering" src="https://img0.baidu.com/it/u=2124903250,3719932312&fm=26&fmt=auto" mode="widthFix"></image> -->
